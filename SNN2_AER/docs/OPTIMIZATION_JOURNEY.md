...
### Analysis
Manual weights were already optimally tuned *locally* — small single-weight changes couldn't improve accuracy. Needed broader exploration.
...
*Optimization method: Random search with hardware-in-the-loop evaluation*  
*Final weights: `/hardware/weight_parameters_optimized.vh`*
